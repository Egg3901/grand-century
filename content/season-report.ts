...
async function main(): Promise<void> {
  ...
  const summaryRows = report.perSeed.map((entry) => ({
    ...
    avgNeedsMetMean: pct(entry.summary.avgNeedsMetMean),
    avgNeedsMetFinal: pct(entry.summary.avgNeedsMetFinal),
    ...
    peakActiveRebellions: entry.summary.peakActiveRebellions,
    peakRebelArmies: entry.summary.peakRebelArmies,
